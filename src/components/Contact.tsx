      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.04, boxShadow: '0 0 40px rgba(37, 211, 102, 0.25)' }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-4 bg-[#25D366] hover:bg-[#22c55e] text-[#110e0a] font-semibold px-10 md:px-14 py-5 text-base md:text-lg uppercase tracking-[0.15em] transition-colors duration-300 cursor-pointer rounded-sm"
          >
            {/* WhatsApp Icon SVG */}
          ...
          <motion.div
            ...
            className="mt-6 w-48 h-1 rounded-full bg-[#25D366]/30"
          />
        </motion.div>
      </div>
    </section>

...
const overlayVariants = {
  hidden: { opacity: 0 },
  visible: { opacity: 1, transition: { duration: 0.45, ease: [0.25, 1, 0.5, 1] as const } },
  exit: { opacity: 0, transition: { duration: 0.35, ease: [0.4, 0, 1, 1] as const, delay: 0.15 } },
};
...
const navContainerVariants = {
  ...
  exit: {
    opacity: 0,
    transition: { staggerChildren: 0.03, staggerDirection: -1 as const, duration: 0.15 },
  },
};
...
const navItemVariants = {
  ...
  exit: { opacity: 0, y: -15, transition: { duration: 0.25, ease: [0.4, 0, 1, 1] as const } },
};
